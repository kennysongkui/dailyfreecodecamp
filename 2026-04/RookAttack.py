...
def rook_attack(rook1, rook2):
    ...
    rook1_row, rook1_col = rook1[:1],rook1[1:]
    rook2_row, rook2_col = rook2[:1], rook2[1:]

    print(rook1_row, rook1_col, rook2_row, rook2_col)

    if rook1_row == rook2_row or rook1_col == rook2_col:
        return True
    else:
        return False
